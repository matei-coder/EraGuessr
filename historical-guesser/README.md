...
- **Firebase** — Cloud Firestore (live leaderboard) + Firebase Hosting
- **Gemini API** — AI scene generation (Nano Banana image model)

## Firebase & AI

Live demo: **https://student-ai26buc-7284.web.app**

This build has a realtime cross-device **leaderboard** (Firestore) and
**AI-generated panoramas** (Gemini image model). See **[FIREBASE.md](FIREBASE.md)**
for setup, the `.env.local` Gemini key, and the note about key exposure on a
public deploy.
